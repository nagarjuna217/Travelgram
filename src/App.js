...
function App() {
  ...
  return (
        ...
        <switch>
          <Route path="/home">
            {currentUser ?
              <div style={{maxWidth : '100hv',height:'100%'}}>
                  <AppBar style={{display : "flex", justifyContent : 'center' ,height : '50px', background : "rgba(237,226,226,0.527)",alignItems:'center',color:'black'}}>
                    <div style={{margin : '10px',fontSize : '170%',fontWeight : 700}}>TravelGram</div>
                  </AppBar>
                
                
                  <div style={{color : 'white',paddingTop : '50px',paddingBotom : '50px',display:'flex',flexDirection:'row', flexWrap: 'wrap',justifyContent:'space-evenly'}}>
                  ...
                  <BottomNavigation
                    ...
                    showLabels
                    style={{zIndex : 1000,position : 'sticky',bottom : 0,width: '100%',background : 'rgba(237,226,226,0.127)'}}
                  >
            ...
            <Route path="/signup">
              <div>
                  <AppBar  style={{display : "flex", justifyContent : 'center' ,height : '50px', background : "rgba(237,226,226,0.527)"}}>
                    <div style={{margin : '10px',fontSize : '170%',fontWeight : 700}}>TravelGram</div>
                  </AppBar>
                  
                  <form  style={{borderRadius : "10%",marginTop : '200px', marginLeft : "40%", background : "rgba(237,226,226,0.527)", padding : "20px",maxWidth : "265px",boxSizing:'border-box'}}>
                    <h1 style={{ color : "#1976d2" }}>signup</h1>
                    <div style={{marginBottom : "10px"}}>
                      <TextField onChange={(e)=>{setPostEmail(e.target.value)}} style={{color : 'white'}} id="standard-basic" label="email" placeholder='enter email ' variant="standard" focused />                      
                    </div>
                    <div style={{marginBottom : "10px"}}>
                      <TextField onChange={(e)=>{setPostUserName(e.target.value)}} style={{color : 'white'}} id="standard-basic" label="Username" placeholder='enter username' variant="standard" focused />                      
                    </div>
                    <div style={{marginBottom : "10px"}}>
                      <TextField type="password" onChange={(e)=>{setPostPassword(e.target.value)}} style={{color : 'white'}} id="standard-basic" label="password" placeholder=" enter password" variant="standard" focused />
                    </div>
            ...
            <Route path="/" exact>
              <div>
                  <AppBar style={{display : "flex", justifyContent : 'center' ,height : '50px', background : "rgba(237, 226, 226, 0.527)",color:'black',alignItems:'center'}}>
                    <div style={{margin : '10px',fontSize : '170%',fontWeight : 700}}>TravelGram</div>
                  </AppBar>
                  
                  <form action="/" method="post" style={{borderRadius : "10%",marginTop : '200px', marginLeft : "40%", background : " rgba(237, 226, 226, 0.527)", padding : "20px", boxSizing:'border-box',maxWidth : "265px"}}>
                    <h1 style={{ color : "#1976d2" }}>login</h1>
                    <div style={{marginBottom : "10px"}}>
                      <TextField onChange={(e)=>{setUserName(e.target.value)}} style={{color : 'white'}} id="standard-basic" label="Username" placeholder='enter username' variant="standard" focused />                      
                    </div>
                    <div style={{marginBottom : "10px"}}>
                      <TextField type="password" onChange={(e)=>{setPassword(e.target.value)}} style={{color : 'white'}} id="standard-basic" label="password" placeholder='enter password' variant="standard" focused />
                    </div>
